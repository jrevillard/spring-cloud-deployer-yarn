...
/**
 * Boot application wrapper combining needed features from application classes from
 * 'org.springframework.yarn.boot.app'. Allows to instantiate context only once making individual
 * command execution much faster still providing all goodies from boot.
 *
...
public class YarnCloudAppServiceApplication implements InitializingBean, DisposableBean {
  ...
  public YarnCloudAppServiceApplication(String applicationVersion, String deployerVersion,
      String configFileName, Properties configFileProperties, String[] runArgs,
  ...
  public List<StreamClustersInfoReportData> getClusterInfo(ApplicationId applicationId,
    ...
    try {
      ...
      data.add(new StreamClustersInfoReportData(
  ...
  public void createCluster(ApplicationId applicationId, String clusterId, String clusterDef,
      String projectionType, Integer projectionDataAny, Map<String, Integer> hosts,
      Map<String, Integer> racks, Map<String, Object> projectionDataProperties,
  ...
  public void destroyCluster(ApplicationId applicationId, String clusterId) {
    Collection<CloudAppInstanceInfo> submittedApplications =
        getSubmittedApplications(applicationId.toString());
  ...
  private synchronized YarnContainerClusterOperations buildClusterOperations(
      RestTemplate restTemplate, YarnClient client, ApplicationId applicationId) {
  ...
  private static String resolveApplicationdir(SpringYarnProperties springYarnProperties,
