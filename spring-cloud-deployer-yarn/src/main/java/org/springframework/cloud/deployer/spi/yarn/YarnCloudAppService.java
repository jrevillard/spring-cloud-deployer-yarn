...
public interface YarnCloudAppService {
	...
	/**
	 * Kill application with given yarn application id.
	 *
	 * @param yarnApplicationId the yarn application id
	 * @param cloudAppType the cloud app type
	 */
	void killApplication(String yarnApplicationId, CloudAppType cloudAppType);
	 ...
	 */
	void createCluster(String yarnApplicationId, String clusterId, int count, String artifact,
	...
	/**
	 * Push artifact into a hdfs directory.
	 *
